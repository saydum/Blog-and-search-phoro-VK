					...
					<div class="box-body pad">
						...
						<form method="POST" action="/admin/addPost" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<br>
								<label>Автор</label>
								<input type="text" placeholder="Admin" name="about">
							</div>
							...
							<textarea class="textarea" name="text" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
